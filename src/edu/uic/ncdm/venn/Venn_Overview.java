...
import static main.PathwayMatrix_1_1.minerList;
import static main.PathwayMatrix_1_1.minerNames;
	...
	*/
	...
	public void draw(float xPanelRight, float yy4, int numSongs) {
        ...
        for (int i = 0; i < centers.length; i++) {
            ...
            Color color = new Color(main.PathwayMatrix_1_1.colorRelations[minerGlobalIDof[i]]);  
            
             // if (deactive[i])
           // 	color = new Color(255,255,255,10);
            
            if (minerGlobalIDof[i]==main.PathwayMatrix_1_1.currentRelation){
            	currentSize = radius;
            }
        ...
        if (minerGlobalIDof!=null && brushing>=0)
        	main.PathwayMatrix_1_1.currentRelation = minerGlobalIDof[brushing];
        else
        	main.PathwayMatrix_1_1.currentRelation = -1;
	...
	public boolean mouseClicked() {
		if (brushing>=0){
			...
			main.PathwayMatrix_1_1.currentRelation = -2;
			return false;
		}	
	}
