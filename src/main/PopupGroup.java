...
public class PopupGroup{
	...
	public static String[] items={"None","Name (Not available yet)", "Similarity"}; 
	public static int s=1;
	//public Slider slider;

	public PopupGroup(PApplet parent_){
		parent = parent_;
	...
	public void draw(float x_){
		x = x_;
		if (main.MainViewer.popupRelation.b<0 && main.MainViewer.popupOrder.b<0)
			checkBrushing();
		if (b>=0){
			parent.fill(100);
			parent.stroke(0);
			...
			parent.text("Group by",x+w1/2,y+18);
		}	
	}
	 ...
	 public void mouseClicked() {
		if (b<items.length){
			...
			if (items[s].equals("None")){  
				...
				main.MainViewer.stateAnimation=0;
			}	
