...
public class PopupOrder{
	...
	public void draw(float x_){
		x = x_;
		if (main.MainMatrixVersion_1_4.popupRelation.b<0)
			checkBrushing();
		if (b>=0){
			parent.fill(100);
			parent.stroke(0);
	 ...
	 public void mouseClicked() {
		if (b<items.length){
			...
			if (items[s].equals("Random")) { 
				main.MainMatrixVersion_1_4.stateAnimation=0;
				main.MainMatrixVersion_1_4.check2.s =false;
			...
			main.MainMatrixVersion_1_4.popupReaction.updateProteinPositions();
		}
	}
