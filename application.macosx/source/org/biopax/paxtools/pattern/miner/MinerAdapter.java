...
public abstract class MinerAdapter implements Miner
{
	...
	public void writeResultAsSIF(Map<BioPAXElement, List<Match>> matches, OutputStream out,
		...
		System.out.println("processingMiner="+main.MainMatrixVersion_1_5.processingMiner+"	"+this.getName()+"	directed="+directed);
	...
	{
		System.out.println("writeResultDetailed="+main.MainMatrixVersion_1_5.processingMiner+
